                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="{{ route('customers.index') }}" class="btn"
                                style="background-color: #4643d3; color: white;"><i class="fas fa-chevron-left"></i> Back
                            </a>
                        </div>
                        <div class="col-md-8">
                            ...
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;"
                                            onclick="if(confirm('Are you sure want to delete the item?')) $('.form-{{ $customer->id }}').submit()"
                                            style="color: #2c2c2c;" class="ms-1 me-1"><i class="fas fa-trash-alt"></i></a>
                                        <form class="form-{{ $customer->id }}"
                                            action="{{ route('customers.forc.destroy', $customer->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
